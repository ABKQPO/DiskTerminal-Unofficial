 ...
 * <p>
 * Each scanner is responsible for a specific type of storage device (e.g., ME Drive, ME Chest).
 */
public interface IStorageScanner {

    /**
     * Get the unique identifier for this scanner. Used for logging and debugging purposes.
     *
