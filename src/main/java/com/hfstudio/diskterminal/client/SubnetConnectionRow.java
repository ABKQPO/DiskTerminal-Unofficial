 ...
 * <p>
 * This is analogous to {@link CellContentRow} but for subnet connections.
 *
...
public class SubnetConnectionRow {
     ...
     */
    public SubnetConnectionRow(SubnetInfo subnet, SubnetInfo.ConnectionPoint connection, int connectionIndex,
        int startIndex, boolean isFirstRow, boolean isPartitionRow, boolean usesSubnetInventory) {
        this.subnet = subnet;
