...
public enum SubnetVisibility {
     ...
     */
    DONT_SHOW("dont_show", "disk_terminal.subnet_visibility.dont_show"),

    /**
     * Show only favorited subnets' content alongside main network.
     */
    SHOW_FAVORITES("favorites", "disk_terminal.subnet_visibility.favorites"),

    /**
     * Show all subnet content alongside main network.
     */
    SHOW_ALL("all", "disk_terminal.subnet_visibility.all");
