...
public interface INetworkTool {
    ...
    class ToolContext {
        ...
        public ToolContext(Map<Long, StorageInfo> storageMap, Map<Long, StorageBusInfo> storageBusMap,
            Map<CellFilter, CellFilter.State> activeFilters, SearchFilterMode searchMode, NetworkToolCallback callback,
