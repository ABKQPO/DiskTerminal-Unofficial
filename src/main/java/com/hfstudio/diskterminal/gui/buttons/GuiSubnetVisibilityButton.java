...
public class GuiSubnetVisibilityButton extends GuiAtlasButton {
    ...
    private void drawModeIndicator(Minecraft mc) {
        int centerX = this.xPosition + SIZE / 2;
        int centerY = this.yPosition + SIZE / 2;
        ...
        switch (currentMode) {
            ...
            case SHOW_FAVORITES:
                // Draw a small star
                mc.fontRenderer.drawString("★", this.xPosition + 3, this.yPosition + 2, COLOR_FAVORITES);
                break;
    ...
    public List<String> getTooltip() {
        ...
        tooltip.add(I18n.format("gui.disk_terminal.subnet_visibility"));
        tooltip.add("§7" + I18n.format(currentMode.getTranslationKey()));
        tooltip.add("");
        tooltip.add("§e" + I18n.format("gui.disk_terminal.click_to_cycle"));
