...
public class GuiBackButton extends GuiAtlasButton {
    ...
    protected int getBackgroundTexY() {
        return GuiConstants.SUBNET_BUTTON_Y + (this.field_146123_n ? SIZE : 0);
    }
    ...
    public List<String> getTooltip() {
        ...
        if (isInOverviewMode) {
            tooltip.add(I18n.format("disk_terminal.subnet.back"));
            tooltip.add("");
            tooltip.add(I18n.format("disk_terminal.subnet.back.desc"));
        } else {
            tooltip.add(I18n.format("disk_terminal.subnet.overview"));
            tooltip.add("");
            tooltip.add(I18n.format("disk_terminal.subnet.overview.desc"));
        }
