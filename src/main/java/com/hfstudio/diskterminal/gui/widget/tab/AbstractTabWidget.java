...
import com.hfstudio.diskterminal.network.PacketUpgradeCell;
...
public abstract class AbstractTabWidget extends AbstractWidget {
    ...
    protected AbstractTabWidget(FontRenderer fontRenderer, RenderItem itemRender) {
        super(
            0,
            GuiConstants.CONTENT_START_Y,
            GuiConstants.CONTENT_RIGHT_EDGE,
            GuiConstants.DEFAULT_ROWS * GuiConstants.ROW_HEIGHT);
     ...
     *
     * @return The tab icon, or null for no icon
     */
    ...
    protected void showUpgradeInsertWarning(String targetName) {
        guiContext.showWarning("disk_terminal.warning.upgrade_insert_failed", targetName);
    }
