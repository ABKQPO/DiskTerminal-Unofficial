package com.hfstudio.diskterminal.gui.widget.button;
...
public enum ButtonType {
    ...
    DO_PARTITION(0, "gui.disk_terminal.button.do_partition"),

    /** Red button: clear all partition entries */
    CLEAR_PARTITION(1, "gui.disk_terminal.button.clear_partition"),

    /** IO mode: read-only */
    READ_ONLY(2, "gui.disk_terminal.button.read_only"),
