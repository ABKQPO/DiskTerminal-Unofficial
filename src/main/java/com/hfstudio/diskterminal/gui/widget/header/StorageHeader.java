...
public class StorageHeader extends AbstractHeader {
    ...
    protected void drawLocation() {
        ...
        fontRenderer.drawString(displayLocation, GuiConstants.HEADER_NAME_X, y + 9, GuiConstants.COLOR_TEXT_SECONDARY);
    }
    ...
    protected void drawExpandIcon(int mouseX, int mouseY) {
        ...
        fontRenderer.drawString(expandIcon, GuiConstants.EXPAND_ICON_X, y + 1, GuiConstants.COLOR_TEXT_PLACEHOLDER);

        // Check expand icon hover (wider area for easy clicking)
        expandHovered = mouseX >= GuiConstants.EXPAND_ICON_X - 2 && mouseX < GuiConstants.CONTENT_RIGHT_EDGE
            && mouseY >= y
    ...
    public boolean handleClick(int mouseX, int mouseY, int button) {
        ...
        if (button == 0) {
            boolean isExpandArea = mouseX >= GuiConstants.EXPAND_ICON_X - 2 && mouseX < GuiConstants.CONTENT_RIGHT_EDGE
                && mouseY >= y
                && mouseY < y + GuiConstants.ROW_HEIGHT;
