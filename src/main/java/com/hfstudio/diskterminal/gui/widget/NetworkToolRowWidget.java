...
import com.hfstudio.diskterminal.gui.networktools.INetworkTool.ToolContext;
import com.hfstudio.diskterminal.gui.networktools.INetworkTool.ToolPreviewInfo;
...
public class NetworkToolRowWidget extends AbstractWidget {
    ...
    public NetworkToolRowWidget(INetworkTool tool, int y, FontRenderer fontRenderer, RenderItem itemRender) {
        super(GuiConstants.GUI_INDENT, y, GuiConstants.CONTENT_RIGHT_EDGE - GuiConstants.GUI_INDENT, ROW_HEIGHT);
        this.tool = tool;
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        helpHovered = mouseX >= helpBtnX && mouseX < helpBtnX + HELP_BUTTON_SIZE
            && mouseY >= helpBtnY
            && mouseY < helpBtnY + HELP_BUTTON_SIZE;
        runHovered = mouseX >= runBtnX && mouseX < runBtnX + RUN_SIZE
            && mouseY >= runBtnY
            && mouseY < runBtnY + RUN_SIZE;
    ...
    private void drawHelpButton() {
        ...
        GuiConstants.drawAtlasSprite(helpBtnX, helpBtnY, texX, texY, HELP_BUTTON_SIZE, HELP_BUTTON_SIZE);
    }
    ...
    private void drawToolIcon(ToolPreviewInfo preview) {
        ...
        if (preview != null && !ItemStacks.isEmpty(preview.getIcon())) {
    ...
    private void drawRunButton() {
        ...
        GuiConstants.drawAtlasSprite(runBtnX, runBtnY, texX, texY, RUN_SIZE, RUN_SIZE);
    }
