...
/**
 * Local stand-in for NEI's {@code IGhostIngredientHandler.Target}.
 * <p>
 * The 1.12 source integrated drag-to-partition through NEI's ghost-ingredient API. On 1.7.10 the
